...
8. Run the following command if you plan to debug on an OS X machine.  This will take a few minutes to compile and install.  brew install curl --with-openssl
